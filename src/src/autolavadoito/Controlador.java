...
public class Controlador {
    ...
    public DefaultTableModel generarModeloTablaOrdenes() {
        String[] columnas = {"Folio", "Cliente", "Vehiculo","Entrada","Salida","Duracion", "Total", "Estado"};
...
o.getHoraEntradaTexto(),

o.getHoraSalidaTexto(),

o.getDuracionTexto(),

"$"+o.getCostoFinal(),

o.getFechaSalida()==null?
